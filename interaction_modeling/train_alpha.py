...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-root", default="outputs/interaction_grip_teacher")
    parser.add_argument("--output-dir", default="outputs/interaction_grip_alpha")
...
def main() -> None:
    ...
    model = GRIPAlphaEstimator(in_channels, args.hidden_channels).to(device)
